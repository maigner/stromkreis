<script>
	...
	const de = (/** @type {number} */ x, digits = 1) =>
	...
	function seenLabel(/** @type {any} */ site) {
	...
	function watt(/** @type {number | null | undefined} */ w) {
	...
	function batteryLabel(/** @type {any} */ s) {
			...
			{:else}
				<div class="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
					{#each data.sites as site (site.id)}
						<div
							class="rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900 {site.online ? '' : 'opacity-75'}"
						>
