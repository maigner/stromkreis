...
The reference implementation and porting source is the ISCHLSTROM monorepo at `~/Workspace/Energiegemeinschaft`; ISCHLSTROM is tenant #1.
...
- Schema authority lives in the platform (single authority, unlike the ISCHLSTROM Django/SvelteKit split). The pipeline consumes the schema as a documented contract.
